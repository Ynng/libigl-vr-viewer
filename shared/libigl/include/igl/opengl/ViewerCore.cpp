  ...
  bool update_matrices)
{
  ...
  //data.meshgl.get_texture_test();
}

IGL_INLINE unsigned int igl::opengl::ViewerCore::draw_buffer(ViewerData& data, unsigned width, unsigned height)
{
